...
class Requsitions extends MX_Controller {
...
*/
	...
	function __construct()
	{
		...
		$this->load->model('requsitions_model');
...
//	   echo 'hello world';
  ...
  function getdatatableajax()
   {
	   ...
	   $this->datatables
			->select("purchases.id as id, date, reference_no, supplier_name, COALESCE(inv_total, 0), COALESCE(total_tax, 0), total, case approved when '1' Then 'Approved' when '0' Then 'Not Approved' when '2' Then 'Cancel' END approved", FALSE)
			->from('purchases');
			
		$this->datatables->add_column("Actions", 
			"<center><a href='#' onClick=\"MyWindow=window.open('index.php?module=requsitions&view=view_inventory&id=$1', 'MyWindow','toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbars=yes,resizable=yes,width=1000,height=600'); return false;\" title='".$this->lang->line("view_inventory")."' class='tip'><i class='icon-fullscreen'></i></a>&nbsp; <a href='index.php?module=requsitions&amp;view=edit&amp;id=$1' title='Process' class='tip'><i class='icon-ban-circle'></i></a>&nbsp; <a href='index.php?module=requsitions&view=pdf_purchase&id=$1' title='Work Order' class='tip'><i class='icon-download'></i></a>
			  &nbsp;<a href='index.php?module=requsitions&amp;view=make_mrr&amp;id=$1' title='Make MRR' class='tip'><i class='icon-adjust'></i></a>&nbsp;
			      <a href='index.php?module=requsitions&amp;view=edit&amp;id=$1' title='".$this->lang->line("edit_inventory")."' class='tip'><i class='icon-edit'></i></a> <a href='index.php?module=requsitions&amp;view=delete&amp;id=$1' onClick=\"return confirm('". $this->lang->line('alert_x_inventory') ."')\" title='".$this->lang->line("delete_inventory")."' class='tip'><i class='icon-trash'></i></a></center>", "id")
   ...
   function getmrrdatatableajax()
   {
	   ...
	   $this->load->library('datatables');
	   $this->datatables
			->select("purchases.id as id, mr_date, reference_no, supplier_name, COALESCE(inv_total, 0), COALESCE(total_tax, 0), total, case mr_status when '2' Then 'Approved' when '1' Then 'Not Approved' when '3' Then 'Cancel' END approved", FALSE)
			->from('purchases')
			->where("mr_status != 0");
		    $this->datatables->add_column("Actions", 
			"<center><a href='#' onClick=\"MyWindow=window.open('index.php?module=requsitions&view=view_inventory&id=$1', 'MyWindow','toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbars=yes,resizable=yes,width=1000,height=600'); return false;\" title='".$this->lang->line("view_inventory")."' class='tip'><i class='icon-fullscreen'></i></a> <a href='index.php?module=requsitions&amp;view=make_mrr&amp;id=$1' title='Process' class='tip'><i class='icon-ban-circle'></i></a>&nbsp;<a href='index.php?module=requsitions&view=pdf_mrr&id=$1' title='MRR Order' class='tip'><i class='icon-download'></i></a></center>", "id")
	...
	function verify_check(){
		...
		redirect("module=requsitions&view=edit&id=".$purchase_id, 'refresh');
	}
	...
	function verify_approve(){
		...
		$purchase_id = $this->input->get('id');
		$this->inventories_model->updateApprove($purchase_id);
  ...
  function mrr_verify_approve(){
		...
		redirect("module=requsitions&view=mrr_list&id=".$purchase_id, 'refresh');
	}
	
	
	function verify_verify(){
   ...
   function getwhinv($warehouse_id = NULL)
   {
	   ...
	   $this->datatables
			...
			->add_column("Actions", 
			"<center><a href='#' onClick=\"MyWindow=window.open('index.php?module=requsitions&view=view_inventory&id=$1', 'MyWindow','toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbars=yes,resizable=yes,width=1000,height=600'); return false;\" title='".$this->lang->line("view_inventory")."' class='tip'><i class='icon-fullscreen'></i></a> <a href='index.php?module=requsitions&view=pdf&id=$1' title='".$this->lang->line("download_pdf")."' class='tip'><i class='icon-file'></i></a> <a href='index.php?module=requsitions&view=pdf_purchase&id=$1' title='Purchase Order' class='tip'><i class='icon-file'></i></a> <a href='index.php?module=requsitions&view=email_inventory&id=$1' title='".$this->lang->line("email_inventory")."' class='tip'><i class='icon-envelope'></i></a> <a href='index.php?module=requsitions&amp;view=edit&amp;id=$1' title='".$this->lang->line("edit_inventory")."' class='tip'><i class='icon-edit'></i></a> <a href='index.php?module=requsitions&amp;view=delete&amp;id=$1' onClick=\"return confirm('". $this->lang->line('alert_x_inventory') ."')\" title='".$this->lang->line("delete_inventory")."' class='tip'><i class='icon-trash'></i></a></center>", "id")
...
function pdf_purchase()
   {
       	...
       	if (!$this->ion_auth->in_group(array('admin', 'owner', 'approver')))
		{
			$this->session->set_flashdata('message', $this->lang->line("access_denied"));
			$data['message'] = (validation_errors() ? validation_errors() : $this->session->flashdata('message'));
			redirect('module=requsitions', 'refresh');
		}
	   ...
	   $groups = array('salesman', 'viewer');
		...
		{ 
			...
			$data['note'] = array('name' => 'note',
				...
				if($this->input->get('alert')){ $alert = $this->input->get('alert'); }
     ...
     function make_mrr($id = NULL)
   {
	   ...
	   $groups = array('salesman', 'viewer');
		...
		{  
			...
			redirect("module=requsitions&view=mrr_list", 'refresh');
	   ...
	   $groups = array('purchaser', 'salesman', 'viewer');
		...
		$config['overwrite'] = TRUE; 
			...
			if( ! $this->upload_photo->do_upload()){
				...
				redirect("module=requsitions&view=csv_inventory", 'refresh');
			} 
