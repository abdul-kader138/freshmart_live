...
<textare id="note" id="note" class="input-block-level" style="margin-top: 10px; height: 100px;" > 
  <table class="table">
	    <tr><td>1</td><td>Terms of Delivery:</td><td style="text-align:left">3 days from date to issue of purchase order</td></tr>
	    ...
	    <tr><td>6</td><td>Partial Delivery: </td><td align="left">No</td></tr>
