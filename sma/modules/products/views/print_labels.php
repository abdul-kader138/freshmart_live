...
@media print
  {
   ...
   #category, .off_print{display: none;}
  }
</style>
</head>
<body>
     <div class="container">
		<h4><?php echo SITE_NAME.' - '.$page_title; ?> <a class="btn btn-primary" href="<?php echo base_url(); ?>index.php?module=home"><i class="icon-home icon-white"></i> <?php echo $this->lang->line('home'); ?></a> <button class="btn btn-danger" onclick="myFunction()">Print</button></h4> 
  
  <label class="control-label off_print" for="category"><?php echo $this->lang->line("category"); ?></label>
 <?php 
