...
<?php $attrib = array('class' => 'form-horizontal'); echo form_open_multipart("module=products&view=update_warehouse_qty", $attrib); ?>
...
<div class="control-group">
    <div class="controls"> <?php echo form_submit('submit', $this->lang->line("update_warehouse_qty"), 'class="btn btn-primary"');?> </div>
</div>
<?php echo form_close();?> 
