...
<div class="control-group">
  <label class="control-label" for="cf3">Customer Group</label>
  <div class="controls">
    <select name="cf3" id="cf3">
      <option value="">Select customer Group</option>
      <option value="Corporate" <?php if($customer->cf3=='Corporate'){ echo 'selected'; } ?>>Corporate</option>
      <option value="Regular" <?php if($customer->cf3=='Regular'){ echo 'selected'; } ?>>Regular</option>
...
<div class="control-group">
  ...
  <div class="controls"> <input type="text" name="cf4" value="<?php echo $customer->cf4; ?>" class="span4" required="required" data-error="<?php echo 'Card No is required'.' '.$this->lang->line("is_required"); ?>" />
  </div>
</div> 
...
<div class="control-group">
  ...
  <div class="controls">
    <select name="cf1" id="cf1" required="required" data-error="Discount Set is required" >
      ...
      <option value="Paragon Products" <?php if($customer->cf1=='Paragon Products'){ echo 'selected'; } ?>>Paragon Products</option>
      <option value="All Products" <?php if($customer->cf1=='All Products'){ echo 'selected'; } ?>>All Products</option>
...
<div class="control-group">
    ...
    <div class="controls">
        ...
        echo form_dropdown('cf5', $ds, $customer->cf5, 'class="span11 tip chzn-select" data-placeholder="' . $this->lang->line("select") . ' ' . $this->lang->line("default_discount") . '" required="required" data-error="' . $this->lang->line("default_discount") . ' ' . $this->lang->line("is_required") . '"');
        ?>
    </div>
</div>
