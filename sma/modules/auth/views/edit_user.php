...
<div class="control-group">
  ...
  <div class="controls">
    ...
    <button type="button" value="5" class="btn <?php if($group->group_id == '6') { echo "active"; } if(isset($_POST['submit']) && ($_POST['role'] == '6')) { echo "active"; } ?>">Purchase Approver</button>
    <button type="button" value="5" class="btn <?php if($group->group_id == '7') { echo "active"; } if(isset($_POST['submit']) && ($_POST['role'] == '7')) { echo "active"; } ?>">Purchase Checker</button>
    <button type="button" value="5" class="btn <?php if($group->group_id == '8') { echo "active"; } if(isset($_POST['submit']) && ($_POST['role'] == '8')) { echo "active"; } ?>">Purchase Verifier</button>
