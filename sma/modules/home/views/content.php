...
$(function () {
    $('#chart_margin').highcharts({
        chart: {},
        credits: {
            enabled: false
        },
        title: {
            text: 'Monthly Sales Margin',
            style: {
                fontSize: '15px',
                padding: '10px',
                fontWeight: 'bold',
        ...
        xAxis: {
            categories: [<?php foreach($sales_months as $months) {
					 echo "'".$months."', ";
				 }
				?>]
        },
...
$(function () {
    $('#tpc').highcharts({
        ...
        title: {
            text: '<?php echo $this->lang->line("best_sellers_category")."-(".date('F Y').")"; ?>',
            style: {
                fontSize: '12px',
                padding: '10px',
                fontWeight: 'bold',
...
$(function () {
    $('#tpcm').highcharts({
        ...
        title: {
            text: '<?php echo $this->lang->line("best_sellers_category_margin")."-(".date('F Y').")"; ?>',
            style: {
                fontSize: '12px',
                padding: '10px',
                fontWeight: 'bold',
...
<div class="row-fluid">
    ...
    <div class="span6">
        <div class="well well-small">
            <div id="chart_margin" style="width:100%; height:300px;"></div>
        </div>
    </div>
...
<?php if ($this->ion_auth->in_group(array('owner', 'admin'))) { ?>
    <ul class="dash">
        ...
        <li>
            <a class="tip" href="index.php?module=products&view=add"
               title="<?php echo $this->lang->line("new_product"); ?>">
        ...
        <li style="position:relative;">
            <a class="tip" href="index.php?module=reports&view=products"
               title="<?php echo $this->lang->line("product_alerts"); ?>">
        ...
        <li>
            <a class="tip" href="index.php?module=inventories&view=add"
               title="<?php echo $this->lang->line("new_purchase"); ?>">
        ...
        <li>
            <a class="tip" href="index.php?module=reports&view=overview"
               title="<?php echo $this->lang->line("reports"); ?>">
...
<?php if ($this->ion_auth->in_group('purchaser') || $this->ion_auth->in_group('approver') || $this->ion_auth->in_group('checker')) { ?>
    <ul class="dash">
        ...
        <li>
            <a class="tip" href="index.php?module=reports&view=purchases"
               title="<?php echo $this->lang->line("reports"); ?>">
                <i><img src="<?php echo $this->config->base_url(); ?>assets/img/icons/report.png" alt=""/></i>
                <span><span><?php echo $this->lang->line("reports"); ?></span></span>
            </a>
...
<?php if ($this->ion_auth->in_group('salesman')) { ?>
    <ul class="dash">
        ...
        <li>
            <a class="tip" href="index.php?module=reports&view=sales"
               title="<?php echo $this->lang->line("reports"); ?>">
                <i><img src="<?php echo $this->config->base_url(); ?>assets/img/icons/report.png" alt=""/></i>
                <span><span><?php echo $this->lang->line("reports"); ?></span></span>
            </a>
