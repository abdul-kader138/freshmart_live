...
<style type="text/css">
    ...
    .table th, .table td:nth-child(3), .table tfoot th:nth-child(3), .table td:nth-child(4), .table tfoot th:nth-child(4) {
        text-align: center;
    }

    .table td:nth-child(5), .table tfoot th:nth-child(5), .table td:nth-child(6), .table tfoot th:nth-child(6) {
        text-align: right;
    }
...
<script>
    $(document).ready(function () {
        ...
        $('#fileData').dataTable({
            ...
            'bProcessing': true,
            'bServerSide': true,
            'sAjaxSource': '<?php echo base_url(); ?>index.php?module=reports&view=getOpening&<?php echo $v; ?>',
...
<div id="form">
    ...
    <?php echo form_open("module=reports&view=opening_stock", "class='form-horizontal'"); ?>
    ...
    <div class="control-group">
        ...
        <div
            class="controls"> <?php echo form_input('start_date', (isset($_POST['start_date']) ? $_POST['start_date'] : ""), 'class="span4" id="start_date"'); ?> </div>
    </div>
    <div class="control-group">
        <label class="control-label" for="end_date"><?php echo $this->lang->line("end_date"); ?></label>

        <div
            class="controls"> <?php echo form_input('end_date', (isset($_POST['end_date']) ? $_POST['end_date'] : ""), 'class="span4" id="end_date"'); ?> </div>
    </div>
...
<?php if ($this->input->post('submit')) { ?>
    <table id="fileData" class="table table-striped table-bordered table-condensed table-hover"
