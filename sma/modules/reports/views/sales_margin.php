...
<script>
    $(document).ready(function() {
        ...
        $('#fileData').dataTable( {
            ...
            'bProcessing'    : true,
            'bServerSide'    : true,
            'sAjaxSource'    : '<?php echo base_url(); ?>index.php?module=reports&view=getSalesMarginByCategory<?php
...
<div class="form">
    ...
    <?php $attrib = array('class' => 'form-horizontal'); echo form_open("module=reports&view=sales_margin", $attrib); ?>
