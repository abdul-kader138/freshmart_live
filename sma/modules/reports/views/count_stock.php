...
<script>
             $(document).ready(function() {
                ...
                $('#fileData').dataTable( {
					...
					'bProcessing'    : true,
					'bServerSide'    : true,
					'sAjaxSource'    : '<?php echo base_url(); ?>index.php?module=reports&view=getVariance&<?php echo $v; ?>',
...
<p>Please customise the report below.</p>
    ...
    <?php echo form_open("module=reports&view=quantity_variance", "class='form-horizontal'"); ?>
