...
<!--                                    <input type="hidden" name="warehouse" id="warehouse" value="--><?php //echo DEFAULT_WAREHOUSE; ?><!--" />-->
                                    ...
                                    <button type="button" class="yellow bot" id="suspend"><?php echo $this->lang->line('suspend'); ?></button>
                                    <button type="button" class="pg bot" id="payment" style="margin-right: 0; width:32%;"><?php echo $this->lang->line('payment'); ?></button>
                                </div>
