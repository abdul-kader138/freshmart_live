...
<head>
    ...
    <script type="text/javascript"> if (parent.frames.length !== 0) {
            top.location = '<?php echo $this->config->base_url(); ?>index.php?module=pos';
        } </script>
    ...
    <link rel="stylesheet" href="<?php echo $this->config->base_url(); ?>assets/css/bootstrap-<?php echo THEME; ?>.css"
          type="text/css"/>
    <link rel="stylesheet" href="<?php echo $this->config->base_url(); ?>assets/pos/css/posajax.css" type="text/css"/>
    <link rel="stylesheet" href="<?php echo $this->config->base_url(); ?>assets/pos/css/print.css" type="text/css"
          media="print"/>
    <script type="text/javascript"
            src="<?php echo $this->config->base_url(); ?>assets/pos/js/jquery-1.7.2.min.js"></script>
    <!--[if lt IE 9]>
    <link rel="stylesheet" type="text/css" href="<?php echo $this->config->base_url(); ?>assets/css/ie.css"/>
    <![endif]-->
...
<div class="navbar navbar-fixed-top">
    <div class="navbar-inner" style="padding-left:10px;">
        ...
        <a class="brand" href="<?php echo $this->config->base_url(); ?>"><img
                src="<?php echo $this->config->base_url(); ?>assets/img/<?php echo LOGO; ?>"
                alt="<?php echo SITE_NAME; ?>"/></a>
        ...
        <div class="nav-collapse collapse">
            <ul class="nav pull-right">
                <li class="dropdown"><a href="#" class="dropdown-toggle"
                    ...
                    <ul class="dropdown-menu">
                        <li>
                            <a href="<?php echo $this->config->base_url(); ?>index.php?module=auth&amp;view=change_password"><?php echo $this->lang->line('change_password'); ?></a>
                        </li>
                        <li class="divider"></li>
                        <li>
                            <a href="<?php echo $this->config->base_url(); ?>index.php?module=auth&amp;view=logout"><?php echo $this->lang->line('logout'); ?></a>
                        </li>
                    </ul>
                </li>
            ...
            <ul class="nav pull-right">
                ...
                <li class="visible-desktop"><a href="index.php?module=home"><?php echo $this->lang->line('home'); ?></a>
                </li>
                <li class="visible-desktop"><a
                        href="<?php echo $this->config->base_url(); ?>index.php?module=pos&amp;view=settings"><?php echo $this->lang->line('pos_settings'); ?></a>
                </li>
                <li class="dropdown"><a href="#" class="dropdown-toggle"
                    ...
                    <ul class="dropdown-menu">
                        <li>
                            <a href="<?php echo $this->config->base_url(); ?>index.php?module=sales"><?php echo $this->lang->line('sales'); ?></a>
                        </li>
                        <li>
                            <a href="<?php echo $this->config->base_url(); ?>index.php?module=pos&amp;view=suspended_sales"><?php echo $this->lang->line('suspended_sales'); ?></a>
                        </li>
                    </ul>
                </li>
                <li><a class="btn btn-success hbtn" href="#"
                       id="todaySale"><?php echo $this->lang->line('today_sale'); ?></a></li>
                <?php
                if (ALERT_NO > 0) {
...
<div id="itemModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
     aria-hidden="true">
...
<div id="returnModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="ReturnModalLabel"
     aria-hidden="true">
    <form id="return_form" action="" method="">
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
            <h3 id="ReturnModalLabel"></h3>
        </div>
        <div class="modal-body">
            <div class="form-horizontal">

                <div class="control-group">
                    <label class="control-label" for="serial_no">Invoice #</label>

                    <div class="controls"
                         style="margin-left:2px;"> <?php echo form_input('invoice', '', 'id="return_ordeer_id" '); ?> <a
                            class="btn btn-primary" onclick="getOrderDetails()">Get Order Info</a></div>
                </div>

            </div>
            <div class="form-horizontal">
                <div class="control-group" id="show_items">
                </div>
            </div>
        </div>
        <div class="modal-footer">
            ...
            <button class="btn btn-primary" id="updateRow_1"><?php echo $this->lang->line('save'); ?></button>
        </div>
    </form>
</div>

<!--- Return Modal END --------->
<div id="paymentModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="paymentModalLabel"
     aria-hidden="true">
<div class="modal-header">
    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
...
<div class="modal-body">
    ...
    <div class="well form-horizontal" style="margin-bottom:0;">
        <div class="control-group" style="font-weight:bold;">
            ...
            <div class="control-group">
                <div class="control-label" style="padding-top:0;font-weight:bold;">
                    Return Amount:
                </div>
                <div class="controls">
<span style="background: #FFFF99; border-radius:5px; padding: 5px 10px; color: #000;">
<span id="twt_return"></span>
</span>
                </div>
            </div>
            <div class="control-group">
                <div class="control-label"
                     style="padding-top:0;font-weight:bold;"><?php echo $this->lang->line("total_payable"); ?>:
                </div>
                <div class="controls"><span
                        style="background: #FFFF99; border-radius:5px; padding: 5px 10px; color: #000;"><span
                            id="twt"></span></span></div>
            </div>
            <div class="control-group" style="font-weight:bold;">
                <div class="control-label"
                     style="padding-top:0;font-weight:bold;"><?php echo $this->lang->line("total_items"); ?>:
                </div>
                <div class="controls"><span
                        style="background: #FFFF99; border-radius:5px; padding: 5px 10px; color: #000;"><span
                            id="item_count"></span></span></div>
            </div>
            <div class="control-group"><label class="control-label"
                                              for="paid_by"><?php echo $this->lang->line("paid_by"); ?></label>
            ...
            <div class="pcc" style="display:none;">
                <div class="control-group"><label class="control-label"
                    ...
                    <div class="controls"><input type="text" id="pcc"/></div>
                </div>
                <div class="control-group"><label class="control-label"
                                                  for="paid-amount"><?php echo $this->lang->line("cc_holder"); ?></label>
            ...
            <div class="pcheque" style="display:none;">
                <div class="control-group"><label class="control-label"
                                                  for="paid-amount"><?php echo $this->lang->line("cheque_no"); ?></label>

                    <div class="controls"><input type="text" id="cheque_no"/></div>
                </div>
            </div>

            <div class="pcc_chash" style="display:none;">
                <div class="control-group"><label class="control-label"
                                                  for="paid-amount"><?php echo $this->lang->line("cc_no"); ?></label>
...
<div id="customerModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="customerModalLabel"
     aria-hidden="true">
    <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
    ...
    <div class="modal-body">
        ...
        <div class="control-group">
            <label class="control-label"
                   for="company"><?php echo $this->lang->line("company") . ": " . $this->lang->line("bypass"); ?></label>

            <div
                class="controls"> <?php echo form_input('company', '', 'class="input-block-level tip" title="' . $this->lang->line("bypass") . '" id="company" '); ?> </div>
        </div>
        <div style="width:100%">
            <div style="width: 48%; float:left;">
                <div class="control-group">
                    ...
                    <div
                        class="controls"> <?php echo form_input('name', '', 'class="input-block-level" id="name" '); ?> </div>
                </div>
                <div class="control-group">
                    <label class="control-label"
                           for="email_address"><?php echo $this->lang->line("email_address"); ?></label>
                ...
                <div class="control-group">
                    <label class="control-label"
                           for="postal_code"><?php echo $this->lang->line("postal_code"); ?></label>

                    <div
                        class="controls"> <?php echo form_input('postal_code', '', 'class="input-block-level" id="postal_code" '); ?> </div>
                </div>
            </div>
            <div style="width: 48%; float:right;">
                <div class="control-group">
                    ...
                    <div
                        class="controls"> <?php echo form_input('address', '', 'class="input-block-level" id="address" '); ?> </div>
                </div>
                <div class="control-group">
                    <label class="control-label" for="city"><?php echo $this->lang->line("city"); ?></label>

                    <div
                        class="controls"> <?php echo form_input('city', '', 'class="input-block-level" id="city" '); ?> </div>
                </div>
                <div class="control-group">
                    <label class="control-label" for="state"><?php echo $this->lang->line("state"); ?></label>

                    <div
                        class="controls"> <?php echo form_input('state', '', 'class="input-block-level" id="state" '); ?> </div>
                </div>
                <div class="control-group">
                    <label class="control-label" for="country"><?php echo $this->lang->line("country"); ?></label>

                    <div
                        class="controls"> <?php echo form_input('country', '', 'class="input-block-level" id="country"'); ?> </div>
                </div>
            </div>
        </div>
    </div>
...
$(document).ready(function () {
    ...
    $("#saletbl").on("click", '.code', function () {
        ...
        <?php } ?>
        <?php if (TAX1) { ?>
        $('#item_tax').val($('#tax_rate-' + rw_no).val());
        <?php } ?>
        <?php if (DISCOUNT_OPTION == 2) { ?>
        $('#item_discount').val($('#discount-' + rw_no).val());
        <?php } ?>
        $('#itemRowId').val(rw_no);
    ...
    $("#updateRow").click(function () {
        ...
        <?php } ?>
        <?php if (TAX1) { ?>
        $('#tax_rate-' + rw_no).val($('#item_tax').val());
        <?php } ?>
        <?php if (DISCOUNT_OPTION == 2) { ?>
        $('#discount-' + rw_no).val($('#item_discount').val());
        <?php } ?>
        var p = '#price-' + rw_no;
    ...
    $("#add-customer").click(function () {
            ...
            "<?php echo $this->security->get_csrf_hash() ?>", data
            :
            newCustomer
        },
        dataType
...
function add_row() {
    $('button[id^="product"]').click(function () {
        ...
        $('#gmail_loading').show();
        var v = $(this).val();
        var cus = $("#customer_id_from_db").val();
        $.ajax({
            type: "get",
            async: false,
...
//
                ...
                new_dis_type_ok_pro = data.discount_new_type;
                ...
                if (promo_type == 1) {
                    ...
                    document.getElementById('buy_1_get_1').innerHTML = parseInt(buyGet) + parseInt(data.promo_get);
...
//        var elm = document.getElementById('protbldiv');
...
function key_pad() {
    $('.keyboard').keyboard({
        ...
        beforeClose: function (e, keyboard, el, accepted) {
            ...
            if (new_discount_type == 1) {
                new_pr_discount = (product_price * discount2) / 100;
            }
            <?php } elseif (DISCOUNT_METHOD == 2) { ?>
            if (new_discount_type == 2) {
                new_pr_discount = new_discount_rate;
...
//        }
    ...
    function (data) {
        if (data != null) {
            ...
            pr_tax = data.tax_rate;
            slast = data.last;
            new_dis_type_ok = data.discount_new_type;
...
$('#paymentModal').on('change', '#s_biller', function () {
    $('#biller').val($(this).val());
});
$('#paymentModal').on('change', '#s_warehouse', function () {
    $('#warehouse').val($(this).val());
});
$('#paymentModal').on('blur', '.pa', function () {
    $('#paid_val').val($(this).val());
});
$('#paymentModal').on('change', '#pcc', function () {
    $('#cc_no_val').val($(this).val());
});
$('#paymentModal').on('change', '#pcc_holder', function () {
    $('#cc_holder_val').val($(this).val());
});
$('#paymentModal').on('change', '#cheque_no', function () {
...
$.ajax({
    ...
    data: {
<?php echo $this->security->get_csrf_token_name(); ?>:
"<?php echo $this->security->get_csrf_hash() ?>", id
: <?php echo $sid; ?>
},
success: function (data) {
    if (data != null) {
...
<script>
    function showHint(str) {
        if (str.length == 0) {
            document.getElementById("scancode").innerHTML = "";
            return;
        } else {
            ...
            xmlhttp.onreadystatechange = function () {
                if (this.readyState == 4 && this.status == 200) {
                    ...
                    $("#scancode").autocomplete({
                        source: availableTags
                    });
                }
            };
            xmlhttp.open("GET", "index.php?module=pos&view=getProductBYname&name=" + str, true);
            xmlhttp.send();
        }
    }
    ...
    $("#return_form").on("submit", function (event) {
        ...
        xmlhttp.onreadystatechange = function () {
            if (this.readyState == 4 && this.status == 200) {
                ...
                document.getElementById("items_return_ref").value = $("#return_ordeer_id").val();

                document.getElementById("items_return_val").value = this.responseText;
                document.getElementById("twt_return").innerHTML = this.responseText;
                document.getElementById("return_amount_in_front").innerHTML = this.responseText;
                var pay_amount = parseFloat($('#twt').html()) - parseFloat(this.responseText);

                $('#twt').html(pay_amount.toFixed(2));
