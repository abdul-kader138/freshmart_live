...
<?php if($message) { echo "<div class=\"alert alert-error\"><button type=\"button\" class=\"close\" data-dismiss=\"alert\">&times;</button>" . $message . "</div>"; } ?>
	...
	<?php $attrib = array('class' => 'form-horizontal'); echo form_open("module=shelfs&view=add", $attrib);?>
...
<div class="control-group">
  <div class="controls"> <?php echo form_submit('submit', $this->lang->line("add_shelf"), 'class="btn btn-primary"');?> </div>
</div>
<?php echo form_close();?> 
