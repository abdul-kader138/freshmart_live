<script>
             $(document).ready(function() {
                $('#fileData').dataTable( {
					...
					'bProcessing'    : true,
					'bServerSide'    : true,
					'sAjaxSource'    : '<?php echo base_url(); ?>index.php?module=shelfs&view=getdatatableajax',
...
<?php if($success_message) { echo "<div class=\"alert alert-success\"><button type=\"button\" class=\"close\" data-dismiss=\"alert\">&times;</button>" . $success_message . "</div>"; } ?>
	...
	<table id="fileData" cellpadding="0" cellspacing="0" border="0" class="table table-bordered table-hover table-striped" style="margin-bottom: 5px;">
        ...
        <tr>
            ...
            <th><?php echo $this->lang->line("shelf_code"); ?></th>
			<th><?php echo $this->lang->line("shelf_name"); ?></th>
	...
	<p><a href="<?php echo site_url('module=shelfs&view=add');?>" class="btn btn-primary"><?php echo $this->lang->line("add_shelf"); ?></a></p>
