...
<div class="control-group">
    <div class="controls">
        ...
        if ($this->ion_auth->in_group(array('admin', 'owner', 'approver'))) {
            if ($inv->mr_status == 1) {
                ?>
                <a href="index.php?module=inventories&view=mrr_verify_approve&id=<?php echo $inv->id ?>">
                    <button type="button" class="btn btn-primary" style="padding: 6px 15px;">Approve</button>
                </a>
                &nbsp;
                <a href="index.php?module=inventories&view=cancel_mrr&id=<?php echo $inv->id ?>">
                    <button type="button" class="btn btn-primary" style="padding: 6px 15px;">Cancel</button>
                </a>
